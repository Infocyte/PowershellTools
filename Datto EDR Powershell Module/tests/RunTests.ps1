...
#Invoke-Pester -Output Detailed -Path "C:\Users\cgerr\Documents\GitHub\PowershellTools\HUNT Powershell Module\tests\status.test.ps1"
#Invoke-Pester -Output Detailed -Path "C:\Users\cgerr\Documents\GitHub\PowershellTools\HUNT Powershell Module\tests\admin.test.ps1"